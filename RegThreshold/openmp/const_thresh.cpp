" ./thresh <img>  <num_threads> <threshold>
"
#include <bits/stdc++.h>
...
int thresh_omp(uint8_t* &gray_img, int width, int height, int threshold, int num_threads){    
...
int main(int argc, char **argv){
    ...
    thresh_omp(gray_img, width, height, argv[3], argv[2]);
    return 1;
}